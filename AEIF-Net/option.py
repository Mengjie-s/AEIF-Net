...
def get_parser():
    ...
    parser.add_argument('--input_type', type=str, default='k_data',
                        help='k_data, image')
    parser.add_argument('--model', type=str, default='ngu_net',
                        help='model type')
...
# with open(r"/home/wwl/disk/cjc2/Mc_Rec_Net_cjc/config.yaml", 'r', encoding='utf-8') as f:
#     default_args = yaml.load(f, Loader=yaml.FullLoader)

with open("F:\\paper\\my paper\\2023_CT_MRI\\code\\Mc_Rec_Net_cjc\\config.yaml", 'r', encoding='utf-8') as f:
    default_args = yaml.load(f, Loader=yaml.FullLoader)
