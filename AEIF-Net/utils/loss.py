...
class FeatureLoss(nn.Module):
    def __init__(self, loss, blocks, weights):
        ...
        # list(vgg.children())[0].in_channels=1
        ...
        self.conv1 = nn.Conv2d(1,3,(3,3),stride=(1, 1), padding=(1, 1))
...
class EdgeLoss(nn.Module):
    def __init__(self):
        ...
        self.kernel = torch.matmul(k.t(),k).unsqueeze(0).repeat(1,1,1,1)  # repeat(3,1,1,1) -> repeat(3,1,1,1) change the input channels
